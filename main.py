...
import pytz
from fasthtml.common import (H1, H2, A, Button, Div, Form, Input, Label, Link,
                             Main, Meta, P, Script, Small, Span, Title,
                             fast_app, serve)
...
def create_message_list(messages: List[Dict[str, Any]]):
  """
...
def create_guest_counter(count: int):
  """
          ...
          Div(
              ...
              Div(
                  Input(
                      ...
                      oninput=(f"updateCharCount('name', 'nameCount', "
                               f"{MAX_NAME_CHAR})"),
                  ),
          ...
          Div(
              ...
              Div(
                  Input(
                      ...
                      oninput=(f"updateCharCount('message', 'messageCount', "
                               f"{MAX_MESSAGE_CHAR})"),
                  ),
